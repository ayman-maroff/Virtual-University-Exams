<?php require '../../../application/config/config.php'; ?>
<!DOCTYPE html>
<html lang="en">
...
<body>
    ...
    <nav class="navbar">
        <div class="navbar__container">
            <a href="#home" id="navbar__logo">Test Center</a>
            ...
            <ul class="navbar__menu">
                ...
                <li class="navbar__item">
                    <a href="<?php echo URL; ?>" class="navbar__links" id="home-page">University</a>
                </li>
                <li class="navbar__item">
                ...
                <li class="navbar__btn">
                    <form action="<?php echo URL; ?>application/views/users/login.php" method="post">
                        <input type="submit" name="btn1" id="signup" class="button" value="Sign In">
                    </form>
                </li>
            </ul>
        </div>
    ...
    <div class="hero" id="home">
        <div class="hero__container">
            <h1 class="hero__heading">Test Center</h1>
